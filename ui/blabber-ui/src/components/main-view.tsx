...
import { AvailableDialects, Transpile } from '../api-utils/api-fetcher';
...
const MainView: React.FC = () => {
    ...
    const [dialectList, setAvailableDialects] = useState<string[]>([]);
    ...
    useEffect(() => {
        async function fetchDialects() {
            const dialects = await AvailableDialects();
    ...
    useEffect(() => {
        const timeoutId = setTimeout(async () => {
            ...
            try {
                const result = await Transpile(inputSQL, inputDialect, outputDialect, prettyPrint);
    ...
    return (
        <div className="main-view bg-dracula-background text-dracula-foreground min-h-screen p-4 lg:px-32 xl:px-64 mt-8 lg:mt-16 xl:mt-24 font-sans">
            ...
            <div className="main-view-input-section mb-4">
                <select
                ...
                <textarea
                    className="input-textarea bg-dracula-selection text-dracula-foreground p-2 rounded mb-2 w-full font-mono"
                    value={inputSQL}
            ...
            {!errors &&
                <div className="main-view-output-section fade-in">
